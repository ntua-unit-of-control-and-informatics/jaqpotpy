...
T = TypeVar("T", bound="SearchModelsResponse200")


@_attrs_define
class SearchModelsResponse200:
    """
    Attributes:
        content (Union[Unset, List['ModelSummary']]):
    ...
    content: Union[Unset, List["ModelSummary"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for content_item_data in _content or []:
            content_item = ModelSummary.from_dict(content_item_data)
        ...
        search_models_response_200 = cls(
            content=content,
        ...
        search_models_response_200.additional_properties = d
        return search_models_response_200
