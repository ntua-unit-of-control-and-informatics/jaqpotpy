...
T = TypeVar("T", bound="GetModelsResponse200")


@_attrs_define
class GetModelsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_models_response_200.additional_properties = d
        return get_models_response_200
