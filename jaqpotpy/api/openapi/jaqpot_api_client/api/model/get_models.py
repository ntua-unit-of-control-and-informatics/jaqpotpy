...
from ...models.get_models_response_200 import GetModelsResponse200
...
) -> Optional[Union[Any, GetModelsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetModelsResponse200.from_dict(response.json())
