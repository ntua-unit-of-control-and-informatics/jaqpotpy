...
class LeverageDoa(BaseModel):
    """
    LeverageDoa
    """ # noqa: E501
    h_star: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="hStar")
    doa_matrix: Optional[Annotated[List[Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=1000)]], Field(max_length=1000)]] = Field(default=None, alias="doaMatrix")
