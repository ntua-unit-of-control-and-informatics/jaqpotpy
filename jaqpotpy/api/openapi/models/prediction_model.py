...
class PredictionModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "dependentFeatures", "independentFeatures", "type", "rawModel", "rawPreprocessor", "doas", "selectedFeatures", "task", "featurizers", "preprocessors", "torchConfig", "extraConfig", "legacyAdditionalInfo", "legacyPredictionService"]
