...
class DatasetApi:
    ...
    def create_dataset(
        ...
        Create a new dataset from the provided data
    ...
    def _create_dataset_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/user/models/{modelId}/datasets',
    ...
    def get_datasets_by_model_id(
        ...
        Retrieve all datasets associated with a specific model ID
        ...
        _param = self._get_datasets_by_model_id_serialize(
            model_id=model_id,
            page=page,
            size=size,
            sort=sort,
    ...
    @validate_call
    def get_datasets_by_model_id_with_http_info(
        self,
        model_id: StrictInt,
        page: Optional[StrictInt] = None,
        size: Optional[StrictInt] = None,
    ...
    @validate_call
    def get_datasets_by_model_id_without_preload_content(
        self,
        model_id: StrictInt,
        page: Optional[StrictInt] = None,
        size: Optional[StrictInt] = None,
    ...
    def _get_datasets_by_model_id_serialize(
        self,
        model_id,
        page,
        size,
