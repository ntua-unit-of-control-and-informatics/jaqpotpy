...
class Feature():
    ...
    def __init__(self,
        ...
        if featureDependency not in ['DEPENDENT', 'INDEPENDENT']:
            raise ValueError(f"possible values for 'featureDependency' are {['DEPENDENT', 'INDEPENDENT']}")
...
# Feature(name='weather', featureDependency='INDEPENDENT', possibleValues=['sunny', 'cloudy']).to_json()

# independentFeatures = []

# for item in Feature.get_feature_names_and_possible_values_from_column_names(independent_feature_names):
