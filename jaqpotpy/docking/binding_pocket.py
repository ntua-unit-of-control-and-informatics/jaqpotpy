...
def extract_active_site(
    ...
    protein = load_molecule(
        protein_file, add_hydrogens=add_hydrogens, calc_charges=calc_charges
    )
    ligand = load_molecule(
        ligand_file, add_hydrogens=add_hydrogens, calc_charges=calc_charges
    )
