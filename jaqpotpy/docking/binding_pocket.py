...
from jaqpotpy.utils.rdkit_utils import load_molecule
from .utils import CoordinateBox, get_face_boxes, merge_overlapping_boxes
from jaqpotpy.utils.fragment_utils import get_contact_atom_indices
...
def extract_active_site(protein_file: str,
  ...
  """
  protein = load_molecule(protein_file, add_hydrogens=add_hydrogens, calc_charges=calc_charges)
  ligand = load_molecule(ligand_file, add_hydrogens=add_hydrogens, calc_charges=calc_charges)
