...
from jaqpotpy.utils.data_utils import pad_array
...
class CoulombMatrix(MolecularFeaturizer):
  ...
  >>> featurizers = jp.descriptors.molecular.CoulombMatrix(max_atoms=23)
  References
  ----------
...
class CoulombMatrixEig(CoulombMatrix):
  ...
  --------
  >>> import jaqpotpy as jp
  >>> featurizers = jp.descriptors.molecular.CoulombMatrixEig(max_atoms=23)
  References
  ----------
  .. [1] Montavon, Grégoire, et al. "Learning invariant representations of
     molecules for atomization energy prediction." Advances in neural information
