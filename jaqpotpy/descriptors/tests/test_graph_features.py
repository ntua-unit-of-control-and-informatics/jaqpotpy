...
class TestConvMolFeaturizer(unittest.TestCase):
    ...
    def test_carbon_nitrogen(self):
        ...
        assert np.array_equal(
            deg_adj_lists[1], np.array([[4], [4], [4], [4]], dtype=np.int32)
        )
        ...
        assert np.array_equal(
            deg_adj_lists[4], np.array([[0, 1, 2, 3]], dtype=np.int32)
        )
    ...
    def test_alkane(self):
        ...
        assert np.array_equal(deg_adj_lists[1], np.array([[2], [2]], dtype=np.int32))
