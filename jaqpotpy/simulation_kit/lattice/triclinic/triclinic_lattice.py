...
# import numpy as np
#
# class SimpleTriclinic(BravaisLattice):
#     """
...
#     >>> sc = jt.simulation_kit.SimpleTriclinic(a = 4.2, b = 9.3, c = 15, aplha=60, beta=60, gamma=60)
#     >>> lattice= sc.construct()
#     >>> type(lattice)
#     <class 'jaqpotpy.simulation_kit.cubic.cubic.SimpleTriclinic'>
#     """
#
...
#         """
#         Construct Triclinic lattice
#
#         Returns
#         -------
#         jaqpotpy.simulation_kit.SimpleTriclinic
#           A Simple Triclinic Lattice lattice
#         """
#
#         degree = np.pi / 180.0
...
#
#         return SimpleTriclinic(self.basis_factor * np.dot(basis, lattice))
#
