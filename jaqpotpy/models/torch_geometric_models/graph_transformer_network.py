...
class GraphTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.hidden_layer = TransformerConv(
            input_dim, hidden_dim, heads, edge_dim=edge_dim
        )
...
class GraphTransformerNetwork(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        graph_layer = GraphTransformerBlock(
            input_dim,
            hidden_dims[0],
            heads=self.heads[0],
            edge_dim=edge_dim,
...
class GraphTransformerNetworkWithExternal(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.graph_model = GraphTransformerNetwork(
