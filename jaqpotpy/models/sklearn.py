...
from jaqpotpy.models import Evaluator, Preprocesses, MolecularModel, MaterialModel, NumericalModel
import sklearn
...
class NumericalSKLearn(Model):

    def __init__(self, dataset: NumericalVectorDataset, doa: DOA, model: Any
