...
from jaqpotpy.models.torch_geometric_models.graph_transformer_network import (
...
class TestGraphTransformerNetwork(unittest.TestCase):
    ...
    def test_forward_pass_multiple_instances(self):
        ...
        model_with_edges = GraphTransformerNetwork(
            input_dim=self.input_dim,
            hidden_dims=self.hidden_dims,
            heads=self.heads,
            edge_dim=self.edge_dim,
    ...
    def test_graph_transformer_block(self):
        ...
        block = GraphTransformerBlock(
            self.input_dim, self.hidden_dims[0], self.heads, self.edge_dim
        )
