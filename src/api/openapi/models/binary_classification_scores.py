...
class BinaryClassificationScores(BaseModel):
    """
    ...
    f1_score: Optional[
        Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=1000)]
    ] = Field(default=None, alias="f1Score")
    jaccard: Optional[
        Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=1000)]
    ] = None
    matthews_corr_coef: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, alias="matthewsCorrCoef"
    )
    confusion_matrix: Optional[
        Annotated[
            List[Annotated[List[Union[StrictFloat, StrictInt]], Field(max_length=100)]],
