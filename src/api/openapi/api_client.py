...
from jaqpotpy.api.openapi.api_response import ApiResponse, T as ApiResponseT
import jaqpotpy.api.openapi.models
from jaqpotpy.api.openapi import rest
from jaqpotpy.api.openapi.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(jaqpotpy.api.openapi.models, klass)
