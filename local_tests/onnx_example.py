...
dataset = JaqpotpyDataset(df = df, y_cols=y_cols,
                          smiles_cols=smiles_cols,  x_cols=x_cols,
...
doa_method = Leverage()
molecularModel_t1 = SklearnModel(dataset=dataset, doa=None, model=model,
...
prediction_dataset = JaqpotpyDataset(df = df, y_cols=None,
                          smiles_cols=smiles_cols,  x_cols=x_cols,
                          task='regression', featurizer=featurizer)
