...
# Set the root folder
root_folder = Path("./")
context = Context(directory=root_folder)
...
for folder in dirs_rglob:
    ...
    # Initialize the Python loader and renderer
    loader = PythonLoader(search_path=[folder])
    loader.init(context)
    renderer.init(context)

    # Load and render the modules
    modules = loader.load()
    markdown = renderer.render_to_string(modules)
